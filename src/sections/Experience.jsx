            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                >
                    <h2 className="flex items-center text-4xl font-black text-[var(--text-primary)] uppercase tracking-[0.2em]">
                        <span className="text-cyan-500 mr-4 font-mono text-2xl opacity-60">04.</span> <TextDecrypt text="Career" /> <span className="ml-3 text-gradient"><TextDecrypt text="Log" delay={500} /></span>
                    </h2>
